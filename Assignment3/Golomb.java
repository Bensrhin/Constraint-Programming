...
public class Golomb {
	...
	SplitSearch1 search = new SplitSearch1(store, 1, "input_order");
        //SplitSearch1 search = new SplitSearch1(store, 1, "first_fail");
        //SplitSearch1 search = new SplitSearch1(store, 1, "smallest");
        //SplitSearch1 search = new SplitSearch1(store, 1, "largest_min");
        //SplitSearch1 search = new SplitSearch1(store, 1, "smallest_max");
        //SplitSearch1 search = new SplitSearch1(store, 1, "most_constraints");
